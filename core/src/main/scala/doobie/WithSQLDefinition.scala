...
/** Allows you to inline a [[SQLDefinition]].
  *
  * This is useful when you want to expose the [[Read]] and [[Write]] of the
  * [[A]] in the companion object.
  *
  * Example:
  * {{{
  ...
  * }}}
  */
trait WithSQLDefinition[A](val sqlDefinition: SQLDefinition[A])
  ...
  override def prefixedWith(prefix: String): Self[A] =
    sqlDefinition.prefixedWith(prefix)
}
